  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'glitch-anim': {
          '0%': { clip: 'rect(32px, 9999px, 94px, 0)', transform: 'skew(0.5deg)' },
          '25%': { clip: 'rect(42px, 9999px, 100px, 0)', transform: 'skew(0.25deg)' },
          '50%': { clip: 'rect(22px, 9999px, 66px, 0)', transform: 'skew(-0.5deg)' },
          '75%': { clip: 'rect(35px, 9999px, 80px, 0)', transform: 'skew(-0.25deg)' },
          '100%': { clip: 'rect(50px, 9999px, 75px, 0)', transform: 'skew(0.5deg)' },
        },
        'glitch-anim-2': {
          '0%': { clip: 'rect(85px, 9999px, 90px, 0)', transform: 'skew(-0.75deg)' },
          '25%': { clip: 'rect(35px, 9999px, 50px, 0)', transform: 'skew(-0.5deg)' },
          '50%': { clip: 'rect(65px, 9999px, 70px, 0)', transform: 'skew(0.75deg)' },
          '75%': { clip: 'rect(10px, 9999px, 45px, 0)', transform: 'skew(0.5deg)' },
        ...
        'glitch-skew': {
          ...
          '70%': { transform: 'skew(1.5deg, -1.5deg)' },
          '80%': { transform: 'skew(-1.5deg, 1.5deg)' },
